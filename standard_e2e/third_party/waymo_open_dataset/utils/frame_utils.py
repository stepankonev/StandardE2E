...
# ==============================================================================
#
# Modifications by StandardE2E contributors (2025): import paths rewritten
# to reference the vendored ``standard_e2e.third_party.waymo_open_dataset``
# namespace. No other changes from the upstream source.
...
from standard_e2e.third_party.waymo_open_dataset import dataset_pb2
from standard_e2e.third_party.waymo_open_dataset.utils import range_image_utils
from standard_e2e.third_party.waymo_open_dataset.utils import transform_utils
