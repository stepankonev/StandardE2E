...
must NOT appear in ``sys.modules``: TF is a Waymo-only extra, and
base-install users (no ``[waymo]``) should be able to import the
framework without TF on disk at all.
